...
import com.present.GifticBe.domain.dto.GoogleLoginResponse;
import com.present.GifticBe.domain.dto.GoogleOAuthRequest;
...
public class ApiRestController {
    ...
    public String oauth_google_check(HttpServletRequest request, @RequestParam(value = "code") String authCode, HttpServletResponse response) throws Exception{
        ...
        //2.구글에 등록된 giftic 설정정보를 보내어 약속된 토큰을 받위한 객체 생성
